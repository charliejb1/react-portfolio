...
import Pdf from './resume-2025.pdf';
    ...
    <>
      ...
      <div>
        ...
        <div id="resume">
          ...
          <ul id="job-1-list">
            <li>Gathered evidence through interviews and database research pertaining to asbestos exposure cases to support client legal action.</li>
            <li>Compiled detailed written reports of case findings to aid client decision-making.</li>
          ...
          <ul id="job-2-list">
            <li>Assisted in creation of managed service promotions and email marketing content ideas to promote the company brand.</li>
            <li>Deactivated broken webpages through coordination with Google and LinkedIn representatives.</li>
            <li>Created social media pages for new clients with necessary company information to onboard new clients.</li>
          </ul>
